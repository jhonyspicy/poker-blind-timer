...
var CHANNEL_ID_PATTERN = /^[A-Za-z0-9_-]{22}$/;
...
__name(createChannelId, "createChannelId");
function channelName(channelId) {
  return `bt:${channelId}`;
}
__name(channelName, "channelName");
...
async function createTokenRequest(apiKey, channelId) {
...
__name(createTokenRequest, "createTokenRequest");
var src_default = {
...
// .wrangler/tmp/bundle-kSqQq1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kSqQq1/middleware-loader.entry.ts
