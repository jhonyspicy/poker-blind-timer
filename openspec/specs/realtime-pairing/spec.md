...
接続用 URL の発行・Ably トークン認証・QR ペアリング・リアルタイムメッセージ同期の基盤を定める。
...
2. 接続が完了したら、チャンネル識別子を含むリモコン用 URL(`/remote?ch=<id>`)を QR コードとその下の URL リンク(新しいタブで開く)で表示し、「操作端末で開いてください」と案内する
